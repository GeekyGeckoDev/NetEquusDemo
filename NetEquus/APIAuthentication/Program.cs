...
using Application.UserApp.UserServices.UserValidationServices;
...
builder.Services.AddScoped<IUserInitilizationService, UserInitilizationService>();
builder.Services.AddScoped<IValidationManagerService, ValidationManagerService>();
